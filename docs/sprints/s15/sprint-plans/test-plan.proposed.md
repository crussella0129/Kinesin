# Sprint 15 Test Plan — proposal awaiting approval

This is a reviewable scratch proposal. Live operation is first; none of the
official unit/integration checks below run until T-123 passes. Named live checks
describe operation and evidence collection, not a preliminary unit-test campaign.
